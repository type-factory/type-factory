...
class InternationalBankAccountNumberTest {
  ...
  @CsvSource(value = {
      ...
      "B171 0961 2345 6769                          | Invalid value - does not match regular-expression pattern [A-Z]{2}+[0-9]{2}+[0-9A-Z]{1,30}+ ",
      "BRA5 0000 0000 0000 1093 2840 814 P2         | Invalid value - does not match regular-expression pattern [A-Z]{2}+[0-9]{2}+[0-9A-Z]{1,30}+ ",
