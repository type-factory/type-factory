...
*/
package org.typefactory.unicode.cldr.generator.unicode.core;
...
public class UnicodeGroupData {
  ...
  private void loadUnicodeContentFromXml(
    ...
    try (final InputStream resourceStream =
      ...
      throw new UnicodeException(org.typefactory.unicode.cldr.generator.unicode.Error.CANNOT_LOAD_UNICODE_ALL_GROUPED_XML_FILE_NAME, unicodeAllGroupedXmlFileName, e);
    }
  }
  ...
  private void parseXml(
        ...
        if (event == XMLStreamConstants.START_ELEMENT) {
          ...
          switch (localName) {
            ...
            case "repertoire":
              ...
              if (repertoireCount > 1) {
                throw new UnicodeException(
                    org.typefactory.unicode.cldr.generator.unicode.Error.THERE_ARE_TOO_MANY_REPERTOIRE_ELEMENTS_IN_THE_FILE,
            ...
            case "blocks":
              ...
              if (blocksCount > 1) {
                throw new UnicodeException(
                    org.typefactory.unicode.cldr.generator.unicode.Error.THERE_ARE_TOO_MANY_BLOCKS_ELEMENTS_IN_THE_FILE,
                    unicodeAllGroupedXmlFileName);
              }
              break;
    ...
    if (repertoireCount == 0) {
      throw new UnicodeException(org.typefactory.unicode.cldr.generator.unicode.Error.THERE_ARE_NO_REPERTOIRE_ELEMENTS_IN_THE_FILE, unicodeAllGroupedXmlFileName);
    }
    if (groupCount == 0) {
      throw new UnicodeException(org.typefactory.unicode.cldr.generator.unicode.Error.THERE_ARE_NO_GROUP_ELEMENTS_IN_THE_FILE, unicodeAllGroupedXmlFileName);
    }
    if (blocksCount == 0) {
