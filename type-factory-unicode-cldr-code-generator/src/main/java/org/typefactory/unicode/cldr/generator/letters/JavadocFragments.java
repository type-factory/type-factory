...
public final class JavadocFragments {
  ...
  public static final String LANGUAGE_ALPHABET_AIM_JAVADOC = """
      <p>Based on the Unicode Common Locale Data Repository (CLDR) dataset, the primary aim
         is to provide language and script specific character sets to assist in the creation of
         custom data-type parsers, especially using Type Factory's {@code TypeParser}.<p>""";
