...
public abstract class AbstractInvalidValueExceptionAssert<SELF extends AbstractInvalidValueExceptionAssert<SELF, ACTUAL>, ACTUAL extends InvalidValueException>
  ...
  public SELF hasInvalidValue(String invalidValue) {
    ...
    if (!Objects.areEqual(actualInvalidValue, invalidValue)) {
  ...
  public SELF hasMessageCode(String messageCode) {
    ...
    if (!Objects.areEqual(actualMessageCode, messageCode)) {
  ...
  public SELF hasParserErrorMessage(String parserErrorMessage) {
    ...
    if (!Objects.areEqual(actualParserErrorMessage, parserErrorMessage)) {
   ...
   */
  public SELF hasParserErrorProperties(java.util.Map parserErrorProperties) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    java.util.Map actualParserErrorProperties = actual.getParserErrorProperties();
    if (!Objects.areEqual(actualParserErrorProperties, parserErrorProperties)) {
  ...
  public SELF hasParserMessageCode(String expected) {
    ...
    if (!Objects.areEqual(actualParserMessageCode, expected)) {
  ...
  public SELF hasTargetTypeClass(Class targetTypeClass) {
    ...
    if (!Objects.areEqual(actualTargetTypeClass, targetTypeClass)) {
   ...
   * @throws AssertionError - if the actual InvalidValueException's messageCode is not equal to the given one.
   */
  public SELF hasMessageCode(org.typefactory.MessageCode messageCode) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.typefactory.MessageCode actualMessageCode = org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("messageCode", org.typefactory.MessageCode.class, actual);
    if (!Objects.areEqual(actualMessageCode, messageCode)) {
      failWithMessage(assertjErrorMessage, actual, messageCode, actualMessageCode);
    }
   ...
   * @throws AssertionError - if the actual InvalidValueException's parserMessageCode is not equal to the given one.
   */
  public SELF hasParserMessageCode(org.typefactory.InvalidValueException.ParserMessageCode parserMessageCode) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    org.typefactory.InvalidValueException.ParserMessageCode actualParserMessageCode = org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCode", org.typefactory.InvalidValueException.ParserMessageCode.class, actual);
    if (!Objects.areEqual(actualParserMessageCode, parserMessageCode)) {
   ...
   */
  public SELF hasParserMessageCodeArgs(java.util.Map parserMessageCodeArgs) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    java.util.Map actualParserMessageCodeArgs = org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgs", java.util.Map.class, actual);
    if (!Objects.areEqual(actualParserMessageCodeArgs, parserMessageCodeArgs)) {
   ...
   */
  public SELF hasParserMessageCodeArgsValues(java.io.Serializable... parserMessageCodeArgsValues) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    Assertions.assertThat(org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgsValues", java.io.Serializable[].class, actual)).contains(parserMessageCodeArgsValues);
   ...
   */
  public SELF hasOnlyParserMessageCodeArgsValues(java.io.Serializable... parserMessageCodeArgsValues) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // check with standard error message (use overridingErrorMessage before contains to set your own message).
    Assertions.assertThat(org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgsValues", java.io.Serializable[].class, actual)).containsOnly(parserMessageCodeArgsValues);
   ...
   */
  public SELF doesNotHaveParserMessageCodeArgsValues(java.io.Serializable... parserMessageCodeArgsValues) {
    // check that actual InvalidValueException we want to make assertions on is not null.
    isNotNull();
    ...
    // check with standard error message (use overridingErrorMessage before contains to set your own message).
    Assertions.assertThat(org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgsValues", java.io.Serializable[].class, actual)).doesNotContain(parserMessageCodeArgsValues);
  ...
  public SELF hasNoParserMessageCodeArgsValues() {
    ...
    if (org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgsValues", java.io.Serializable[].class, actual).length > 0)  {
      failWithMessage(assertjErrorMessage, actual, java.util.Arrays.toString(org.assertj.core.util.introspection.FieldSupport.EXTRACTION.fieldValue("parserMessageCodeArgsValues", java.io.Serializable[].class, actual)));
    }
