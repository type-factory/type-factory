...
public interface NumericTypeParser<V extends Number & Comparable<V>, T extends NumberType<V, T>> {
  ...
  /**
   * Returns the value of the given short value as an instance of the type {@code V}→{@link Number} after verifying that it conforms to all the type
   * parser rules.
   *
   * @param value the short value to be validated by the type parser.
   * @return the value of the given short value as an instance of the type {@code V}→{@link Number}
  ...
  /**
   * Returns the value of the given integer value as an instance of the type {@code V}→{@link Number} after verifying that it conforms to all the type
   * parser rules.
   *
   * @param value the integer value to be validated by the type parser.
   * @return the value of the given integer value as an instance of the type {@code V}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  V of(Integer value) throws InvalidValueException;

  /**
   * Returns the value of the given long value as an instance of the type {@code V}→{@link Number} after verifying that it conforms to all the type
   * parser rules.
   *
   * @param value the long value to be validated by the type parser.
   * @return the value of the given long value as an instance of the type {@code V}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  V of(Long value) throws InvalidValueException;

  /**
   * Returns the value of the given big-integer value as an instance of the type {@code V}→{@link Number} after verifying that it conforms to all the
   * type parser rules.
   *
   * @param value the big-integer value to be validated by the type parser.
   * @return the value of the given big-integer value as an instance of the type {@code V}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  V of(BigInteger value) throws InvalidValueException;

  /**
   * Returns the value of the given char-sequence value as an instance of the type {@code V}→{@link Number} after parsing and verifying that it
   * conforms to all the type parser rules.
   *
   * @param value the char-sequence value to be parsed and validated by the type parser.
   * @return the value of the given char-sequence value as an instance of the type {@code V}→{@link Number}
  ...
  /**
   * Returns the value of the given short value as an instance of {@code S}→{@link NumberType}→{@link Number} after verifying that it conforms to all
   ...
   *                                   {@code S}→{@link NumberType}.
   * @param <S>                        the subclass type of the {@link NumberType} instance to be created.
   * @return the value of the given short value as an instance of the type {@code S}→{@link NumberType}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  <S extends T> S of(Short value, Function<V, S> constructorOrFactoryMethod) throws InvalidValueException;

  /**
   * Returns the value of the given integer value as an instance of {@code S}→{@link NumberType}→{@link Number} after verifying that it conforms to
   ...
   *                                   {@code S}→{@link NumberType}.
   * @param <S>                        the subclass type of the {@link NumberType} instance to be created.
   * @return the value of the given integer value as an instance of the type {@code S}→{@link NumberType}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  <S extends T> S of(Integer value, Function<V, S> constructorOrFactoryMethod) throws InvalidValueException;

  /**
   * Returns the value of the given long value as an instance of {@code S}→{@link NumberType}→{@link Number} after verifying that it conforms to all
   * the type parser rules.
   *
   * @param value                      the long value to be validated by the type parser.
   * @param constructorOrFactoryMethod the constructor or factory method to be used for creating the instance of the type
   *                                   {@code S}→{@link NumberType}.
   * @param <S>                        the subclass type of the {@link NumberType} instance to be created.
   * @return the value of the given long value as an instance of the type {@code S}→{@link NumberType}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  <S extends T> S of(Long value, Function<V, S> constructorOrFactoryMethod) throws InvalidValueException;

  /**
   * Returns the value of the given big-integer value as an instance of {@code S}→{@link NumberType}→{@link Number} after verifying that it conforms
   ...
   *                                   {@code S}→{@link NumberType}.
   * @param <S>                        the subclass type of the {@link NumberType} instance to be created.
   * @return the value of the given big-integer value as an instance of the type {@code S}→{@link NumberType}→{@link Number}
   * @throws InvalidValueException if the given value fails to conform to the type parser rules.
   */
  <S extends T> S of(BigInteger value, Function<V, S> constructorOrFactoryMethod) throws InvalidValueException;

  /**
   * Returns the value of the given char-sequence value as an instance of {@code S}→{@link NumberType}→{@link Number} after parsing and verifying that
   ...
   *                                   {@code S}→{@link NumberType}.
   * @param <S>                        the subclass type of the {@link NumberType} instance to be created.
   * @return the value of the given char-sequence value as an instance of the type {@code S}→{@link NumberType}→{@link Number}
   * @throws InvalidValueException if the given value fails to be parsed or does not conform to the type parser rules.
   */
