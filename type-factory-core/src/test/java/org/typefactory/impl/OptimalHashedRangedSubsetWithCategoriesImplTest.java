...
class OptimalHashedRangedSubsetWithCategoriesImplTest {

  @Test
  void isEmpty_returnsTrue() {
    final var actual = new OptimalHashedRangedSubsetWithCategoriesImpl(
        0,
        new char[0],
        new char[0][],
        0,
  ...
  void contains_returnsAsExpected(
    ...
    final var actual =
        new OptimalHashedRangedSubsetWithCategoriesImpl(
