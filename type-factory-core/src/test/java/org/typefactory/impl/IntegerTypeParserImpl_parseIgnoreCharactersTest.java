...
class IntegerTypeParserImpl_parseIgnoreCharactersTest {

  @ParameterizedTest
  @CsvSource(textBlock = """
            VALUE   |    EXPECTED | COMMENTS
      -2147483648   | -2147483648 | hyphen-minus Integer.MIN_VALUE
  ...
  @CsvSource(textBlock = """
            VALUE   |    EXPECTED | COMMENTS
      -2147483647   |  2147483647 | hyphen-minus Integer.MIN_VALUE + 1
              -20   |          20 | hyphen-minus twenty
         \u221219   |          19 | math-minus nineteen
      '  \u279618 ' |          18 | Whitespace heavy-minus eighteen
          '  - 17 ' |          17 | Whitespace hyphen-minus seventeen
  ...
  @CsvSource(textBlock = """
               VALUE   |    EXPECTED | COMMENTS
      -2-147-483-647   |  2147483647 | hyphen-minus Integer.MIN_VALUE + 1
      ...
      -2_147_483_648   | -2147483648 | hyphen-minus Integer.MIN_VALUE
         __\u221219    |         -19 | Math-minus nineteen
          ...
          _\u2212_9    |          -9 | Math-minus nine
              ...
              __  1 __ |           1 | One
                _+1_   |           1 | Plus One
       2_147_483_646   |  2147483646 | Plus Integer.MAX_VALUE - 1
      +2_147_483_647   |  2147483647 | Plus Integer.MAX_VALUE
      """,
      delimiter = '|',
      useHeadersInDisplayName = true)
  ...
  @CsvSource(textBlock = """
      ...
      -2*147*483*648   | -2147483648 | hyphen-minus Integer.MIN_VALUE
       ...
       2_147~483_646   |  2147483646 | Plus Integer.MAX_VALUE - 1
      +2~147~483~647   |  2147483647 | Plus Integer.MAX_VALUE
      """,
      delimiter = '|',
      useHeadersInDisplayName = true)
