...
/**
 * Provides Type Factory subsets for the Macedonian as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Macedonian language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class mk extends root {
  ...
  /**
   * <p>The decimal digit characters for the Macedonian language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
