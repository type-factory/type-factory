...
/**
 * Provides Type Factory subsets for the Kalaallisut as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Kalaallisut language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class kl extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Kalaallisut language.</p>
   *
   * <p>Language tag: {@code "kl"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Kalaallisut language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
