...
public final class cv extends AbstractCldrResourceBundle {
  ...
  /**
   * <p>The auxiliary characters for the Chuvash language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
  ...
  /**
   * <p>The punctuation characters for the Chuvash language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
