...
/**
 * Provides Type Factory subsets for the Tibetan as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Tibetan language is generated from the
...
public class bo extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Tibetan language.</p>
   *
   * <p>Language tag: {@code "bo"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Tibetan language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
