...
/**
 * Provides Type Factory subsets for the Norwegian Nynorsk as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Norwegian Nynorsk language is generated from the
...
public class nn extends no {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Norwegian Nynorsk language.</p>
   *
   * <p>Language tag: {@code "nn"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Norwegian Nynorsk language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
