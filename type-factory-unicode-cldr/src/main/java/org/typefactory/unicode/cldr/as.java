...
/**
 * Provides Type Factory subsets for the Assamese as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Assamese language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class as extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Assamese language.</p>
   *
   * <p>Language tag: {@code "as"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Assamese language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
