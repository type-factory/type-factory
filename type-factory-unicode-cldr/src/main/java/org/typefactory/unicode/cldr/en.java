...
/**
 * Provides Type Factory subsets for the English as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the English language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class en extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the English language.</p>
   *
   * <p>Language tag: {@code "en"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the English language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
