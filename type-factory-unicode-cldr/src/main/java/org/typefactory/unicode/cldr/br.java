...
/**
 * Provides Type Factory subsets for the Breton as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Breton language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class br extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Breton language.</p>
   *
   * <p>Language tag: {@code "br"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Breton language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
