...
/**
 * Provides Type Factory subsets for the Malayalam as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Malayalam language is generated from the
...
public class ml extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Malayalam language.</p>
   *
   * <p>Language tag: {@code "ml"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Malayalam language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
