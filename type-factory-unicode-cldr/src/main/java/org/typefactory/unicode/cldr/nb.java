...
public final class nb extends CldrResourceBundle {
  ...
  /**
   * <p>The auxiliary characters for the Norwegian Bokmål language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
  ...
  /**
   * <p>The punctuation characters for the Norwegian Bokmål language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
