...
/**
 * Provides Type Factory subsets for the French as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the French language is generated from the
...
public class fr extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the French language.</p>
   *
   * <p>Language tag: {@code "fr"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the French language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
