...
/**
 * Provides Type Factory subsets for the Slovak as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Slovak language is generated from the
...
public class sk extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Slovak language.</p>
   *
   * <p>Language tag: {@code "sk"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Slovak language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
