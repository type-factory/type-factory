...
/**
 * Provides Type Factory subsets for the Occitan as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Occitan language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class oc extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Occitan language.</p>
   *
   * <p>Language tag: {@code "oc"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Occitan language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
