...
/**
 * Provides Type Factory subsets for the Luba-Katanga as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Luba-Katanga language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class lu extends root {
  ...
  /**
   * <p>The decimal digit characters for the Luba-Katanga language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
