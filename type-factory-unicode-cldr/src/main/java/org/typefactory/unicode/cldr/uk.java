...
/**
 * Provides Type Factory subsets for the Ukrainian as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Ukrainian language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class uk extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Ukrainian language.</p>
   *
   * <p>Language tag: {@code "uk"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Ukrainian language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
