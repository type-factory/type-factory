...
/**
 * Provides Type Factory subsets for the Tajik as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Tajik language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class tg extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Tajik language.</p>
   *
   * <p>Language tag: {@code "tg"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Tajik language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
