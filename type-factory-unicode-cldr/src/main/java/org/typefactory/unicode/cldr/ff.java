...
/**
 * Provides Type Factory subsets for the Fulah as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Fulah language is generated from the
...
public class ff extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Fulah language.</p>
   *
   * <p>Language tag: {@code "ff"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Fulah language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
