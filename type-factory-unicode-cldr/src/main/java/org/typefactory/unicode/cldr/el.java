...
/**
 * Provides Type Factory subsets for the Greek as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Greek language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class el extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Greek language.</p>
   *
   * <p>Language tag: {@code "el"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Greek language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
