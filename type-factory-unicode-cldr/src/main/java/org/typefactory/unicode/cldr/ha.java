...
/**
 * Provides Type Factory subsets for the Hausa as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Hausa language is generated from the
...
public class ha extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Hausa language.</p>
   *
   * <p>Language tag: {@code "ha"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Hausa language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
