...
/**
 * Provides Type Factory subsets for the Malagasy as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Malagasy language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class mg extends root {
  ...
  /**
   * <p>The decimal digit characters for the Malagasy language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
