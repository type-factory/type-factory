...
/**
 * Provides Type Factory subsets for the Gujarati as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Gujarati language is generated from the
...
public class gu extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Gujarati language.</p>
   *
   * <p>Language tag: {@code "gu"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Gujarati language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
