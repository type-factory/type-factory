...
/**
 * Provides Type Factory subsets for the Tongan as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Tongan language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class to extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Tongan language.</p>
   *
   * <p>Language tag: {@code "to"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Tongan language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
