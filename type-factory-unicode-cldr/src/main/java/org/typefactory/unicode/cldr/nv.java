...
/**
 * Provides Type Factory subsets for the Navajo as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Navajo language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class nv extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Navajo language.</p>
   *
   * <p>Language tag: {@code "nv"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Navajo language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
