...
/**
 * Provides Type Factory subsets for the Lithuanian as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Lithuanian language is generated from the
...
public class lt extends root {
  ...
  /**
   * <p>The decimal digit characters for the Lithuanian language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
