...
/**
 * Provides Type Factory subsets for the Guarani as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Guarani language is generated from the
...
public class gn extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Guarani language.</p>
   *
   * <p>Language tag: {@code "gn"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Guarani language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
