...
/**
 * Provides Type Factory subsets for the Church Slavic as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Church Slavic language is generated from the
...
public class cu extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Church Slavic language.</p>
   *
   * <p>Language tag: {@code "cu"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Church Slavic language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
