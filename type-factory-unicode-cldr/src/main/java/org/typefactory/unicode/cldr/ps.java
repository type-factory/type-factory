...
/**
 * Provides Type Factory subsets for the Pashto as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Pashto language is generated from the
...
public class ps extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Pashto language.</p>
   *
   * <p>Language tag: {@code "ps"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Pashto language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
