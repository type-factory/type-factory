...
/**
 * Provides Type Factory subsets for the Italian as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file for the Italian language is generated from the
        Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
public class it extends root {
  ...
  /**
   * <p>The Locale represented by this resource bundle for the Italian language.</p>
   *
   * <p>Language tag: {@code "it"}</p>
   */
  ...
  /**
   * <p>The decimal digit characters for the Italian language as defined by the
   *    Unicode Common Locale Data Repository (CLDR).</p>
   *
