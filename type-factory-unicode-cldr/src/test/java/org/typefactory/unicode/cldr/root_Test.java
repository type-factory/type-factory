...
/**
 * Unit tests for the root language 'root' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the root language 'root' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class root_Test extends AbstractCldrResourceBundle_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new root();
    ...
    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_root");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_root");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new root(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new root().getPunctuationSubset();
  ...
  void getDecimalDigitsSubset_containsExpectedCodePoints(
    ...
    final var subset = new root().getDecimalDigitsSubset();
