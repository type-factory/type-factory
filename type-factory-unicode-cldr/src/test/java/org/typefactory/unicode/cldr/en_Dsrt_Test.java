...
/**
 * Unit tests for the English (Deseret) language 'en_Dsrt' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the English (Deseret) language 'en_Dsrt' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class en_Dsrt_Test extends en_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new en_Dsrt();

    assertThat(instance)
        .isInstanceOf(en_Dsrt.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_en_Dsrt");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_en_Dsrt");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new en_Dsrt(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new en_Dsrt().getStandardSubset();
