...
class kn_Test extends root_Test {
  ...
  void defaultConstructor_successfullyCreatesInstance() {
    ...
    final var instance = new kn();

    assertThat(instance)
        .isInstanceOf(kn.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_kn");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_kn");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new kn(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
