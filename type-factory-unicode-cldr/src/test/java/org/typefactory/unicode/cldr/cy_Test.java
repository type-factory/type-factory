...
/**
 * Unit tests for the Welsh language 'cy' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Welsh language 'cy' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class cy_Test extends root_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new cy();

    assertThat(instance)
        .isInstanceOf(cy.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_cy");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_cy");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new cy(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new cy().getStandardSubset();
  ...
  void getAuxiliarySubset_containsExpectedCodePoints(
    ...
    final var subset = new cy().getAuxiliarySubset();
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new cy().getPunctuationSubset();
