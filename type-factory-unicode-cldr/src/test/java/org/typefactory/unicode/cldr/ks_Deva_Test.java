...
/**
 * Unit tests for the Kashmiri (Devanagari) language 'ks_Deva' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Kashmiri (Devanagari) language 'ks_Deva' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class ks_Deva_Test extends ks_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new ks_Deva();

    assertThat(instance)
        .isInstanceOf(ks_Deva.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_ks_Deva");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_ks_Deva");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new ks_Deva(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new ks_Deva().getStandardSubset();
  ...
  void getAuxiliarySubset_containsExpectedCodePoints(
    ...
    final var subset = new ks_Deva().getAuxiliarySubset();
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new ks_Deva().getPunctuationSubset();
