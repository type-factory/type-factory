...
/**
 * Unit tests for the Portuguese (Portugal) language 'pt_PT' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Portuguese (Portugal) language 'pt_PT' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class pt_PT_Test extends pt_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new pt_PT();

    assertThat(instance)
        .isInstanceOf(pt_PT.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_pt_PT");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_pt_PT");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new pt_PT(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new pt_PT().getPunctuationSubset();
  ...
  void getDecimalDigitsSubset_containsExpectedCodePoints(
    ...
    final var subset = new pt_PT().getDecimalDigitsSubset();
