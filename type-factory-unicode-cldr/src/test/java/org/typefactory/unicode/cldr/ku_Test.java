...
class ku_Test extends root_Test {
  ...
  void defaultConstructor_successfullyCreatesInstance() {
    ...
    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_ku");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_ku");
  }
