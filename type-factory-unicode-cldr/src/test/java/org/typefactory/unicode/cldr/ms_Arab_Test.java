...
class ms_Arab_Test extends ms_Test {
  ...
  void defaultConstructor_successfullyCreatesInstance() {
    ...
    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_ms_Arab");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_ms_Arab");
  }
