...
/**
 * Unit tests for the Occitan (Spain) language 'oc_ES' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Occitan (Spain) language 'oc_ES' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class oc_ES_Test extends oc_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new oc_ES();

    assertThat(instance)
        .isInstanceOf(oc_ES.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_oc_ES");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_oc_ES");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new oc_ES(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new oc_ES().getPunctuationSubset();
