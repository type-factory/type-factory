...
@Generated(
    comments = """
        This file of unit tests for the Belarusian (Taraskievica orthography) language 'be_TARASK' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class be_TARASK_Test extends be_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new be_TARASK();
    ...
    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_be_TARASK");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_be_TARASK");
  }
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new be_TARASK().getStandardSubset();
  ...
  void getDecimalDigitsSubset_containsExpectedCodePoints(
    ...
    final var subset = new be_TARASK().getDecimalDigitsSubset();
