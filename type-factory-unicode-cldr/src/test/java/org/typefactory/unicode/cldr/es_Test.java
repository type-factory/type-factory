...
/**
 * Unit tests for the Spanish language 'es' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Spanish language 'es' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class es_Test extends root_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new es();

    assertThat(instance)
        .isInstanceOf(es.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_es");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_es");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new es(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new es().getStandardSubset();
  ...
  void getAuxiliarySubset_containsExpectedCodePoints(
    ...
    final var subset = new es().getAuxiliarySubset();
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new es().getPunctuationSubset();
