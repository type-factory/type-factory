...
/**
 * Unit tests for the Hebrew language 'he' resource bundle as defined
 * by the Unicode Common Locale Data Repository (CLDR).
 */
@Generated(
    comments = """
        This file of unit tests for the Hebrew language 'he' resource bundle is generated
        from the Unicode Common Locale Data Repository (CLDR) datasets.""",
    value = "org.typefactory:type-factory-unicode-cldr-code-generator")
class he_Test extends root_Test {

  @Test
  void defaultConstructor_successfullyCreatesInstance() {

    final var instance = new he();

    assertThat(instance)
        .isInstanceOf(he.class)
        .isInstanceOf(root.class)
        .isInstanceOf(AbstractCldrResourceBundle.class)
        .isInstanceOf(ResourceBundle.class);

    assertThat(instance.resourceBundleName()).isEqualTo("org.typefactory.unicode.cldr_he");
    ...
    assertThatExceptionOfType(MissingResourceException.class)
        ...
        .withMessage("Cannot load locale data for key 'nonexistent_key' from resource org.typefactory.unicode.cldr_he");
  }
  ...
  void constructor_successfullyCreatesInstanceWithParameters(
    ...
    final var instance = new he(standardSubset, auxiliarySubset, punctuationSubset, decimalDigitsSubset);
  ...
  void getStandardSubset_containsExpectedCodePoints(
    ...
    final var subset = new he().getStandardSubset();
  ...
  void getAuxiliarySubset_containsExpectedCodePoints(
    ...
    final var subset = new he().getAuxiliarySubset();
  ...
  void getPunctuationSubset_containsExpectedCodePoints(
    ...
    final var subset = new he().getPunctuationSubset();
  ...
  void getDecimalDigitsSubset_containsExpectedCodePoints(
    ...
    final var subset = new he().getDecimalDigitsSubset();
