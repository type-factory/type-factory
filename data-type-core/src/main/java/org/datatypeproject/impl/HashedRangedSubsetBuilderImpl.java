...
//
//class HashedRangedSubsetBuilderImpl implements HashedRangedSubsetBuilder {
//
...
//
//  @Override
//  public HashedRangedSubsetBuilder includeSubset(Subset subset) {
...
//                codePointRangesByBlock[hashIndex][hashBucketIndex],
//                codePointRangesSizes[hashIndex][hashBucketIndex]);
//            numberOfCodePointRanges += codePointRangesSizes[hashIndex][hashBucketIndex];
