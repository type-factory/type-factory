...
import static org.datatypeproject.generator.language.JavadocFragments.LANGUAGE_ALPHABET_AIM_JAVADOC;
import static org.datatypeproject.generator.language.JavadocFragments.LANGUAGE_ALPHABET_IF_YOU_SEE_A_MISTAKE_JAVADOC;
import static org.datatypeproject.generator.language.JavadocFragments.LANGUAGE_ALPHABET_INCLUDED_JAVADOC;
import static org.datatypeproject.generator.language.JavadocFragments.LANGUAGE_ALPHABET_NOT_INCLUDED_JAVADOC;
import static org.datatypeproject.generator.language.JavadocFragments.SEE_ALSO_ALPHABETS_LETTERS_AND_DIACRITICS_IN_EUROPEAN_LANGUAGES;
import static org.datatypeproject.generator.language.JavadocFragments.SEE_ALSO_COMMON_ARABIC_SCRIPT_REFERENCES;
...
public enum LanguageData {
  ...
  LETTERS_JAPANESE_JA_JINMEIYO(
      ...
      new char[]{
          ...
          '亞', '惡', '爲', '逸', '榮', '衞', '謁', '圓', '緣', '薗', '應', '櫻', '奧', '橫', '溫', '價', '禍', '悔', '海', '壞', '懷', '樂', '渴', '卷', '陷', '寬', '漢', '氣',
...
//      '०', '१', '२', '३', '४', '५', '६', '७', '८', '९'}),
  ...
  LanguageData(final ULocale locale, final UnicodeSet unicodeSet, String... javadoc) {
    this(locale, null, null, unicodeSet, javadoc);
  }

  LanguageData(final ULocale locale, final UnicodeSet unicodeSet, final char[] chars, String... javadoc) {
